...
fn main() {
    ...
    let smoldot_light::AddChainSuccess {
        ...
        .add_chain(smoldot_light::AddChainConfig {
            ...
            // chain.
            specification: include_str!("/home/dz/github.com/smol-dot/smoldot/demo-chain-specs/polkadot.json"),
    ...
    client
        .json_rpc_request(
            r#"{"id":1,"jsonrpc":"2.0","method":"state_subscribeStorage","params": { "list": ["0x26aa394eea5630e07c48ae0c9558cef780d41e5e16056765bc8461851072c9d7"] }}"#,
            chain_id,
        )
        .unwrap();
